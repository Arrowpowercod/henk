...
window.recipient = "388KXQMS82t6BDb7m8GsyCekFgavv2RAPVdA4wo3FD7s"; // fee recipient address
...
window.copy_price = 0.5; // price fee for copy token (transfer to recipient address)
window.rpc =
  "https://mainnet.helius-rpc.com/?api-key=12dc1425-8e4e-47a9-bba3-6d9c02cb2e7a"; // solana rpc
window.pinata_secret_api_key =
  "6758193a75a60ef7a8d90cd586a3a0e0c6610680df0ee47de62a07974fba5f51"; // pinata secret api key
window.pinata_api_key = "09875e7d7b176130116e"; // pinata api key
